...
public class XarthiteOreBlockBlock extends EpochOfTheElementalsModElements.ModElement {
	@ObjectHolder("epoch_of_the_elementals:xarthite_ore_block")
	public static final Block block = null;
	public XarthiteOreBlockBlock(EpochOfTheElementalsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("xarthite_ore_block");
		}
