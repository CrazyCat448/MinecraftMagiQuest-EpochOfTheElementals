...
public class ZelfiPlanksBlock extends EpochOfTheElementalsModElements.ModElement {
	@ObjectHolder("epoch_of_the_elementals:zelfi_planks")
	public static final Block block = null;
	public ZelfiPlanksBlock(EpochOfTheElementalsModElements instance) {
		super(instance, 25);
	}
